...
public class MklibraryfxmlController {
    ...
    public void returnBooks(){
        try {
            ...
            MKLibrary.getReturnBookStage().setScene(new Scene(root));

            ReturnBookFXMLController returnBookController = loader.getController();
            returnBookController.createBookList();
                    
            MKLibrary.getReturnBookStage().show();
...
//        MKLibrary.getLibrary().add(new Book("The Catcher in the Rye", "J.D. Salinger", 1951, "A children's General Works novel", "General Works"));
        try {
            ...
            searchBookController.createBookList(searchBookController);
